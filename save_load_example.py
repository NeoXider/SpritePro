...
def main():
    ...
    s.debug_log_info(f"   ✓ Загружены настройки, разрешение: {loaded_settings['graphics']['resolution']}")
...
- Игра сохранена
    ...
    s.debug_log_info(f"   ✓ Загружено состояние: уровень {loaded_state['current_level']}, "
