...
class Sprite(pygame.sprite.Sprite):
    ...
    def DoKill(self, complete: bool = False) -> "Sprite":
        ...
        Args:
            complete: Если True — применить конечное значение и вызвать on_complete.
                Для твинов с SetYoyo(True) применяется «логический конец» (исходная
                стартовая позиция), так что спрайт возвращается в точку старта анимации.
