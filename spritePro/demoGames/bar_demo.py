...
def create_demo_bars():
    ...
    v_bar1.set_fill_type(
        FillDirection.BOTTOM_TO_TOP, s.Anchor.CENTER
    )  # Center anchor for vertical bars
    ...
    v_bar2.set_fill_type(
        FillDirection.TOP_TO_BOTTOM, s.Anchor.CENTER
    )  # Center anchor for vertical bars
