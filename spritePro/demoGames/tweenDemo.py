...
if __name__ == "__main__":
    ...
    demo_instructions = font.render(
        "Press 1 for single sprite demo, 2 for dual sprite demo, ESC to exit",
        True,
        (255, 255, 255),
    )
    instructions_pos = (
        screen.get_width() // 2 - demo_instructions.get_width() // 2,
        10,
    )
    ...
    while True:
        ...
        if current_demo == 1:
            single_demo_initialized = run_single_tween_demo(
                tween_manager, single_sprite, single_demo_initialized
            )
        else:
            dual_demo_initialized = run_dual_tween_demo(
                tween_manager, (sprite1, sprite2), dual_demo_initialized
            )
        ...
        if current_demo == 1:
            ...
            pygame.draw.line(
                spritePro.screen, (50, 50, 50), (200, 100), (200, 500), 2
            )  # Для sprite1
            pygame.draw.line(
                spritePro.screen, (50, 50, 50), (200, 300), (600, 300), 2
            )  # Для sprite2
            pygame.draw.line(
                spritePro.screen, (50, 50, 50), (600, 100), (600, 500), 2
            )  # Для sprite2 вертикаль
