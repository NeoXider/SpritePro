...
def main() -> None:
    ...
    def reset() -> None:
        ...
        if active_kill_handle:
            ...
            active_kill_handle = None
        box.set_position(base_pos)
        box.set_scale(base_scale)
        box.rotate_to(base_angle)
        box.set_alpha(base_alpha)
        box.set_color(base_color)
        box_loop.set_position(base_pos_loop)
        box_loop.set_scale(1.0)
        box_loop.set_color((255, 180, 100))
        box_loop.set_alpha(255)
        box_kill.set_position(base_pos_kill)
        box_kill.set_scale(1.0)
        box_kill.set_color((150, 255, 150))
        box_kill.set_alpha(255)
