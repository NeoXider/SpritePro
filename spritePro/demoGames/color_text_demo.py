...
class ColorTextDemo:
    ...
    def setup_text_effects(self):
        ...
        effects = [
            ...
            {
                'text': 'BROKEN LIGHT',
                'func': lambda: ColorEffects.flicker(speed=12.0, base_color=(255, 255, 255), flicker_color=(200, 200, 200), randomness=0.9),
            ...
            {
                'text': 'SLOW STROBE',
                'func': lambda: ColorEffects.strobe(speed=1.5, on_color=(0, 255, 0), off_color=(0, 50, 0), duty_cycle=0.7),
            ...
            {
                'text': 'FOREST WAVE',
                'func': lambda: ColorEffects.wave(speed=1.2, colors=[(0, 100, 0), (50, 150, 50), (100, 200, 100), (0, 255, 0)]),
                'description': 'Forest colors wave'
            },
            {
                'text': 'CYBER PULSE',
                'func': lambda: ColorEffects.pulse(speed=2.5, base_color=(0, 50, 100), target_color=(0, 255, 255), intensity=0.9),
                'description': 'Cyberpunk cyan pulse'
            },
            {
                'text': 'LAVA BREATHING',
                'func': lambda: ColorEffects.breathing(speed=0.4, base_color=(200, 50, 0), intensity=0.8),
    ...
    def draw_color_categories(self):
        ...
        categories = [
            ("Pulse Effects", (200, 80), ColorEffects.pulse(speed=1.0, base_color=(255, 100, 100), target_color=(255, 200, 200))),
            ("Rainbow & Wave", (550, 80), ColorEffects.rainbow(speed=2.0, saturation=0.7)),
            ("Breathing & Flicker", (900, 80), ColorEffects.breathing(speed=0.8, base_color=(100, 255, 100)))
        ]
