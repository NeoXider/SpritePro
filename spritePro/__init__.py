...
__all__ = ["GameSprite", "PhysicalSprite", "Sprite", "Button", "PymunkGameSprite", "Timer", "TextSprite", "MouseInteractor"]
...
def get_screen(size: tuple[int, int], title: str = "Игра", icon: str = None) -> pygame.Surface:
