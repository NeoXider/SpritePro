...
Подробная информация о всех модулях и компонентах библиотеки.

## Куда идти

| Цель | Документ |
|------|----------|
| **Всё по полочкам** (главная карта) | [DOCUMENTATION_INDEX.md](../DOCUMENTATION_INDEX.md) — содержание по разделам, демо, порядок изучения |
