...
#### [Physics](physics.md)
Система физики: типы тел (DYNAMIC, STATIC, KINEMATIC), PhysicsWorld, PhysicsConfig, PhysicsBody, коллизии AABB, колбэк on_collision, границы мира. Подробное описание API и демо (physics_demo, hoop_bounce_demo).
