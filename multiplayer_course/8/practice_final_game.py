"""Практика 8: финальная сборка с TODO.
...
def update_score_text(text_sprite: s.TextSprite, scores: dict) -> None:
    # TODO: вынесите форматирование счета сюда.
    pass
...
class GameScene(s.Scene):
    ...
    def update(self, dt):
        ...
        # Отправка позиции.
        ctx.send_every("pos", {"x": pos.x, "y": pos.y}, SEND_INTERVAL)
...
def multiplayer_main(net: s.NetClient, role: str, color: str) -> None:
    ...
    # Настройка сцен.
    s.get_screen(SCREEN_SIZE, "Lesson 8 - Practice")
