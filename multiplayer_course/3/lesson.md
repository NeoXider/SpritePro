...
### Задание 3: Дуэль реакции 🔥

Превратите готовность в мини-игру: после того как оба нажали Ready, хост ждёт случайные 1–4 секунды и рассылает `"go"`. Кто первым нажмёт SPACE после сигнала — тот победил (нажал до сигнала — фальстарт, проигрыш). Хост сравнивает время получения нажатий и объявляет победителя. Это уже настоящая сетевая игра — из одного урока!
