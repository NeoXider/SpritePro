...
### Задание 3: Перетягивание зоны 🔥

Сделайте зону подвижной: пока в ней стоит только один игрок, она медленно ползёт К НЕМУ (хост двигает и рассылает позицию зоны). Стоят оба — зона замирает. Получается перетягивание каната: очки капают тому, кто удержал зону у себя. Всю логику движения и счёта держит хост — клиенты только рисуют.
